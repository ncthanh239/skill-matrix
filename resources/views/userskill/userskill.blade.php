      ...
      <div class="box-body">
        <div class="table-responsive table-scroll" id="table-scroll">
          ...
          <table class="table">
            <thead>
              <tr>
                <th class="blackhd "><span class="">{{__('text.STT')}}</span></th>
                <th class="blackhd col-code "><span class="">{{__('text.code')}}</span></th>
                <th class="blackhd col-name"><span class="">{{__('text.name')}}</span></th>
                @if(count($skills)>0)
            ...
            <tbody>
              ...
              <tr>
                <td>{{$key}}</td>
                <td>{{$value['code']}}</td>
                <td class="text-body"><a class="click-show text-body text-decoration-none" href="/chart/Id/{{$value['id']}}">{{$value['name']}}</a></td>
